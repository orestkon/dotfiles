...
-- Save when nvim loses focus or when switching buffers
...
require("lazy").setup({
			...
			require("mason-lspconfig").setup({
				...
				handlers = {
					function(server_name)
						...
						-- This handles overriding only explicitly passed
	...
	{ -- You can easily change to a different colorscheme.
		...
		config = function()
			...
			-- 	},
			-- })
			-- Configuration options go before the colorscheme command
			vim.g.gruvbox_material_background = "hard"
			vim.g.gruvbox_material_foreground = "material"
			vim.g.gruvbox_material_enable_italic_comments = 0 -- Replaces your 'italic = false' logic
			--
